import 'package:fintech/features/loan_screens/views_ui/fill_form.dart';
...
import 'package:fintech/features/loan_screens/views_ui/request_loan.dart';
...
class AppRoutes {
  static Map<String, WidgetBuilder> routes = {
    ...
    MyRoutes.loanRequest: (context) => RequestLoan(),
    MyRoutes.fillForm: (context) => FillForm(),
  };
}
